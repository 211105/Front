...
const URL = 'http://3.145.184.109:3001/api/product/view'
...
const CompShowBlogs = () => {
    ...
    const urlupdate = 'http://3.145.184.109:3001/api/product/update'
    ...
    const urldelet = 'http://3.145.184.109:3001/api/product/delete'
